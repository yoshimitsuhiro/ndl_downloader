...
left = np.min(x_nonzero[0:img.shape[1]*100*3]) #measures leftmost non-black pixel starting approx. 100 pixels from topto avoid top border and page-turning arrows
